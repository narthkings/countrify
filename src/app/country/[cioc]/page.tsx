...
const Cioc = () => {
    ...
    const { data: country, isFetching } = useFetchSingleCountry(cioc as string);
    return (
        <>
            <Link href="/">
                ...
                <section className="max-w-4xl mx-auto px-4 py-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm sm:text-base">
                        <div className="space-y-2">
                            ...
                            <p>
                                <span className="font-medium">Region:</span> {country?.[0]?.region}
                            </p>
                            <p>
                                <span className="font-medium">Subregion:</span> {country?.[0]?.subregion}
                            </p>
                            <p>
